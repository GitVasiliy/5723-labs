...
public class BoardPanel extends JPanel {
    ...
    public BoardPanel(boolean active, ClientAction clientAction) {
        ...
        try {
            imgSea = ImageIO.read(new FileInputStream("C:/kursovaya/client/gfx/sea1.jpg"));
            imgSplash = ImageIO.read(new FileInputStream("C:/kursovaya/client/gfx/splash.jpg")); 
            imgFire = ImageIO.read(new FileInputStream("C:/kursovaya/client/gfx/fire.jpg"));
            imgShipReveal = ImageIO.read(new FileInputStream("C:/kursovaya/client/gfx/shipReveal.jpg"));
            imgShipProwH = ImageIO.read(new FileInputStream("C:/kursovaya/client/gfx/shipProwH.jpg"));
            imgShipProwV = ImageIO.read(new FileInputStream("C:/kursovaya/client/gfx/shipProwV.jpg"));
            imgShipBoardH = ImageIO.read(new FileInputStream("C:/kursovaya/client/gfx/shipBoardH.jpg"));
            imgShipBoardV = ImageIO.read(new FileInputStream("C:/kursovaya/client/gfx/shipBoardV.jpg"));
