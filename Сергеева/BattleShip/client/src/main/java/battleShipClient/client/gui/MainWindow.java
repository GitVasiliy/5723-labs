...
public class MainWindow {
    ...
    public MainWindow(ClientAction clientAction, ClientReaction clientReaction) {
        ...
        fMain = new JFrame();
        fMain.setTitle("Battle Ship Client");
        fMain.setLayout(new BorderLayout());
        fMain.setSize(new Dimension(640, 480));
        ...
        try {
            imgBackground = ImageIO.read(new FileInputStream("C:/kursovaya/client/gfx/background1.jpg"));
        } catch (IOException e) {
             e.printStackTrace();
        }
        ...
        bPlayAgain = new JButton(Text.PLAY_AGAIN);
