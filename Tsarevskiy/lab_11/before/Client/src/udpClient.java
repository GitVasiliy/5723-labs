...
public class udpClient extends Thread {
    ...
    public void sendMessege() throws  Exception{
        ...
        DatagramPacket packet = new DatagramPacket(sendData, sendData.length, InetAddress.getByName(this.adress),9876);
        socket.send(packet);
    }
    ...
    public void sendMessege(String name) throws  Exception{
        ...
        DatagramPacket packet = new DatagramPacket(form.getBytes(), form.length(),InetAddress.getByName(this.adress),9876);
        socket.send(packet);
    }
