...
import io.ReadProducts;
import io.WriteProducts;
...
public class WebShopServlet extends HttpServlet {
	...
	private void messageErrorNotAvailableProduct(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		String pathCSS1 = "\"style\\style.css\"";
		String pathCSS2 = "\"style\\menu.css\"";
	...
	private String showAllProductsForUsers(ArrayList<Product> products, String category, String sort) {
		...
		for(int i = 0; i < products.size(); i++) {
			...
			html.append("<div class = 'productBox' id='prod" + i + "'>");  //у каждого id prodX
	...
	private String createMenuCategories(boolean admin) {
		...
		//открывающий список с видами сортировок
		...
		//открывающийся список с категориями
		...
		html.append("<li>");
		html.append("<form action='webShop' method='get'>");
		html.append("<input type='submit' value='Phones'>");
		html.append("<input type='hidden' name='category' value='phones'>");
		html.append("</form>");
		html.append("</li>");
		//категория часы
		html.append("<li>");
		html.append("<form action='webShop' method='get'>");
		html.append("<input type='submit' value='Clocks'>");
		html.append("<input type='hidden' name='category' value='clocks'>");
		html.append("</form>");
		html.append("</li>");
		//категория ноутбуки
		html.append("<li>");
		html.append("<form action='webShop' method='get'>");
		html.append("<input type='submit' value='Laptops'>");
		html.append("<input type='hidden' name='category' value='laptops'>");
		html.append("</form>");
		html.append("</li>");
		html.append("</ul>");
		html.append("</li>");
